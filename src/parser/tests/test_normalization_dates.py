...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("12.11.2025", date(2025, 11, 12), RULE_NUMERIC_DAY_FIRST),
        ("12/11/2025", date(2025, 11, 12), RULE_NUMERIC_DAY_FIRST),
...
def test_resolve_date_text_rejects_a_month_first_numeric_date() -> None:
    # 11/25 cannot be day-first, so it is refused rather than reordered.
    resolution = resolve_date_text("11/25/2025")
...
def test_resolve_cell_date_falls_back_to_readable_text() -> None:
    assert resolve_cell_date(text_cell("12.11.2025")).value == date(2025, 11, 12)
