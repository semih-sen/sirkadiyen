...
/// <summary>A proposed catalog document, and the on-disk document it was edited from.</summary>
public sealed record PreviewSourceCatalogRequest
{
...
/// <summary>The confirmation of a previewed catalog change.</summary>
public sealed record ApplySourceCatalogRequest
{
    public required string Content { get; init; }
