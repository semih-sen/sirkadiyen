...
builder.Services.AddScoped<FinancePeriodResolver>();
builder.Services.AddScoped<FinanceObligationService>();
builder.Services.AddScoped<FinanceSummaryService>();
builder.Services.AddScoped<FinanceDistributionService>();
