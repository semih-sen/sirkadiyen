...
public static partial class DepartmentCatalog
{
    ...
    [
        ...
        D("histoloji-ve-embriyoloji", "Histoloji ve Embriyoloji", DepartmentDivision.Basic, "#8E24AA", "histology and embryology", "histology & embryology", "histoloji embriyoloji", "histoloji ve embiriyoloji", "histoloji", "embriyoloji", "embiriyoloji", "histology", "embryology"),
        ...
        D("ruh-sagligi-ve-hastaliklari", "Ruh Sağlığı ve Hastalıkları", DepartmentDivision.Internal, null, "psychiatry", "psikiyatri","ruh sağlığı ve hastalıkları ad" ),
