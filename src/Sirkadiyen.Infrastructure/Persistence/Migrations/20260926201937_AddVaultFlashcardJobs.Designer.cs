...
namespace Sirkadiyen.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926201937_AddVaultFlashcardJobs")]
    partial class AddVaultFlashcardJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sirkadiyen.Domain.GoogleCalendar.GoogleCalendarConnection", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("RetiredRemovalAuthorizedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("google_calendar_connections", "sirkadiyen", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_google_calendar_connections_retired_removal", "\"RetiredRemovalAuthorizedAtUtc\" IS NULL OR \"ProfileResyncRequiredSinceUtc\" IS NOT NULL");
            ...
            modelBuilder.Entity("Sirkadiyen.Domain.Meals.MealCalendarDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Category", "State", "LocalDate");

                    b.HasIndex("UserId", "LocalDate", "Category")
                        .IsUnique();

                    b.ToTable("meal_calendar_deliveries", "sirkadiyen", t =>
                        {
                            t.HasCheckConstraint("ck_meal_calendar_deliveries_skip_reason", "(\"State\" <> 'Skipped') OR (\"SkipReason\" IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("Sirkadiyen.Domain.Meals.MealMenuDay", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ConsecutiveMissCount")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LocalDate", "Category")
                        .IsUnique();

                    b.HasIndex("Category", "Status", "LocalDate");

                    b.ToTable("meal_menu_days", "sirkadiyen");
                });

            modelBuilder.Entity("Sirkadiyen.Domain.Meals.MealMenuSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("meal_menu_subscriptions", "sirkadiyen");
                });
            ...
            modelBuilder.Entity("Sirkadiyen.Domain.Scheduling.Diffing.ScheduleDiff", b =>
                {
                    ...
                    b.HasIndex("CurrentRevisionId")
                        .IsUnique()
                        .HasDatabaseName("IX_schedule_diffs_CurrentRevisionId");
            ...
            modelBuilder.Entity("Sirkadiyen.Domain.Scheduling.Publication.ScheduleRevision", b =>
                {
                    ...
                    b.Property<int>("DiffAttempts")
                        .HasColumnType("integer");

                    b.Property<string>("DiffFailureReason")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.Property<DateTimeOffset?>("DiffRetriedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("DiffRetriedBy")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("DiffRetryReason")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.Property<string>("DiffState")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<DateTimeOffset?>("NextDiffAttemptAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("DiffState", "NextDiffAttemptAtUtc");

                    b.HasIndex("ScheduleSourceId", "CreatedAtUtc");

                    b.HasIndex("State", "CreatedAtUtc");

                    b.ToTable("schedule_revisions", "sirkadiyen", t =>
                        {
                            t.HasCheckConstraint("ck_schedule_revisions_diff_attempts", "\"DiffAttempts\" >= 0");

                            t.HasCheckConstraint("ck_schedule_revisions_diff_state", "\"DiffState\" IN ('Pending', 'Failed')");
                        });
                });
            ...
            modelBuilder.Entity("Sirkadiyen.Domain.Scheduling.Sources.ScheduleSource", b =>
                {
                    ...
                    b.Property<bool>("PublishesSchedule")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Sirkadiyen.Infrastructure.Persistence.Vault.VaultNoteJobRow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<string>("Backlinks")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("vault_note_jobs", "sirkadiyen");
                });
