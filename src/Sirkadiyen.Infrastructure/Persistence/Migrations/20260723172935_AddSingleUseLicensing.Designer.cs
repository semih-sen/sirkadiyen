...
namespace Sirkadiyen.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260723172935_AddSingleUseLicensing")]
    partial class AddSingleUseLicensing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sirkadiyen.Domain.Licensing.License", b =>
                {
                    ...
                    b.ToTable("licenses", "sirkadiyen", t =>
                        {
                            t.HasCheckConstraint("ck_licenses_code_hash_length", "octet_length(\"CodeHash\") = 32");
            ...
            modelBuilder.Entity("Sirkadiyen.Domain.Licensing.LicenseAudit", b =>
                {
                    ...
                    b.ToTable("license_audits", "sirkadiyen", t =>
                        {
                            t.HasCheckConstraint("ck_license_audits_action", "\"Action\" IN ('Created', 'Redeemed', 'Revoked', 'Expired')");
                        });
                });
