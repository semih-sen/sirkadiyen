...
function Dashboard() {
  ...
  return <div className="student-shell"><StudentTopbar subtitle={subtitle} onSignOut={onSignOut} /><main id="main" style={{ padding: '32px 0 80px' }}><div className="container">
    ...
    {/* Her kart bir `.dash-cell` sarmalayıcısı içinde: masaüstünde iki sütun aynı
        kalır, 900px altında sütunlar `display: contents` ile çözülüp kartlar
        `order` ile yeniden sıralanır (profil en üstte). */}
    <div className="dashboard-grid">
      <div className="stack" style={{ gap: 20 }}>
        <div className="dash-cell dash-cell--summary">
        ...
        <div className="dash-cell dash-cell--upcoming">
        ...
        <div className="dash-cell dash-cell--changes">
        ...
        <div className="dash-cell dash-cell--repair">
        ...
        <div className="dash-cell dash-cell--colors"><DepartmentColorEditor mode="user" collapsible /></div>
      </div>
      <div className="stack" style={{ gap: 20 }}>
        ...
        <div className="dash-cell dash-cell--calendar">
        ...
        <div className="dash-cell dash-cell--soon">
        ...
        <div className="dash-cell dash-cell--danger"><DeleteAccountCard /></div>
      </div>
    </div>
  </div></main></div>;
}
